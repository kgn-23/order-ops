...
export async function getOrderDetails(orderId: string): Promise<OrderDetailPayload> {
  ...
  return {
    ...
    country: row.country,
    refinedAddress: row.refinedAddress,
    ...
    commerceStatusTimeline: row.commerceStatusEvents.map((item) => ({
      id: item.id,
    ...
    commerceSnapshot: {
      ...
      merchantOrderCreatedAt: row.merchantOrderCreatedAt ? row.merchantOrderCreatedAt.toISOString() : null,
      financialStatus: row.financialStatus,
      fulfillmentStatus: row.fulfillmentStatus,
      currencyCode: row.currencyCode,
      subtotalAmount: row.subtotalAmount?.toString() ?? null,
      shippingAmount: row.shippingAmount?.toString() ?? null,
      taxesAmount: row.taxesAmount?.toString() ?? null,
